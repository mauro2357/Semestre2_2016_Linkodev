 ...
 */
public class EliminacionNotificacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            usr.eliminarNotificacion(mensaje);
            request.getRequestDispatcher("Notificaciones").forward(request, response);
        } catch (Exception e) {
